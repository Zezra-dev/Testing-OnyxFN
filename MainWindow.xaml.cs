...
using OnyxFN_Launcher.Epic_Shit;
using OnyxFN_Launcher.JsonParser;
using OnyxFN_Launcher.Properties;
using OnyxFN_Launcher.Utilities;
using System;
...
namespace OnyxFN_Launcher
{
    public partial class MainWindow : Window
    {
        ...
        private void LaunchButton_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            var nativePath = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "OnyxNative.dll");
            if (!File.Exists(nativePath))
            {
                var text = "Your Native Is Not In The Same Path As Launcher You Dumb Kid.";
                MessageBox.Show(text);
                return;
            }
        ...
        {
            Process.Start("https://discord.gg/onyxfn");
        }

        /*private void Button_Click_2(object sender, RoutedEventArgs e)
        {
            Process.Start("https://onyxfn.tk/panel?user=" + accountId);
        }*/
    }
}
